...
function () {
  ...
  _createClass(RNAiquaBase, null, [{
    ...
    value: function configure(_ref) {
      ...
      if (!appId) {
        console.warn('APP ID must be provided!');
        return;
      }
    ...
    value: function setToken(token) {
      console.warn("'setToken' is not supported on ".concat(Platform.OS));
    }
    /**
     * Logs an event.
    ...
    value: function setPhoneNumber(phoneNo) {
      console.warn("'setPhoneNumber' is not supported on ".concat(Platform.OS));
    }
  }, {
    ...
    value: function enablePushBooster() {
      console.warn("'enablePushBooster' is not supported on ".concat(Platform.OS));
    }
  }, {
    key: "disableGATracking",
    value: function disableGATracking() {
      console.warn("'disableGATracking' is not supported on ".concat(Platform.OS));
    }
  }, {
    key: "getTrackerId",
    value: function getTrackerId(callback) {
      console.warn("'getTrackerId' is not supported on ".concat(Platform.OS));
    }
  }, {
    ...
    value: function isQGMessage(message, callback) {
      console.warn("'isQGMessage' is not supported on ".concat(Platform.OS));
    }
  }, {
    ...
    value: function getStoredNotifications(callback) {
      console.warn("'getStoredNotifications' is not supported on ".concat(Platform.OS));
    }
  }, {
    key: "deleteStoredNotifications",
    value: function deleteStoredNotifications() {
      console.warn("'deleteStoredNotifications' is not supported on ".concat(Platform.OS));
    }
  }, {
    key: "setUtmSource",
    value: function setUtmSource(utmSource) {
      console.warn("'setUtmSource' is not supported on ".concat(Platform.OS));
    }
  }, {
    key: "setUtmMedium",
    value: function setUtmMedium(utmMedium) {
      console.warn("'setUtmMedium' is not supported on ".concat(Platform.OS));
    }
  }, {
    key: "setUtmTerm",
    value: function setUtmTerm(utmTerm) {
      console.warn("'setUtmTerm' is not supported on ".concat(Platform.OS));
    }
  }, {
    key: "setUtmContent",
    value: function setUtmContent(utmContent) {
      console.warn("'setUtmContent' is not supported on ".concat(Platform.OS));
    }
  }, {
    key: "setUtmCampaign",
    value: function setUtmCampaign(utmCampaign) {
      console.warn("'setUtmCampaign' is not supported on ".concat(Platform.OS));
    }
  }]);
